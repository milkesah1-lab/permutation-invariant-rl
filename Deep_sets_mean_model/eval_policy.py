...
def eval_policy(policy, env, num_episodes, render=False, max_steps=None, label="Evaluation Summary"):
	"""
	...
	cov_var = torch.full(size=(act_dim,), fill_value=0.08, device=device)
