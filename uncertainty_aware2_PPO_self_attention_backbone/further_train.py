...
model_name = os.environ.get(
    "UNCERTAINTY_AWARE_CHECKPOINT",
    os.environ.get(
        "BASELINE_CHECKPOINT",
        f"uncertainty_aware_ppo_{config_name}_lambda_u_{hyperparameters['lambda_u']}",
    ),
)
actor_checkpoint, critic_checkpoint = resolve_checkpoint_pair(model_name)
new_model_name = os.environ.get(
    "OUTPUT_CHECKPOINT",
    f"uncertainty_aware_ppo_{config_name}_continued_lambda_u_{hyperparameters['lambda_u']}",
)
output_prefix = resolve_output_prefix(new_model_name)
